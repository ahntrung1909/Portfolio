        ...
        <div className="flex items-center gap-x-[16px] text-xl">
          ...
          {locale === "vi" ? (
            <Link
              href={pathname}
              locale="en"
              className="py-[10px] px-[20px] bg-sky-300 flex rounded-[10px] items-center justify-center text-base"
            >
              en
            </Link>
          ) : (
            <Link
              href={pathname}
              locale="vi"
              className="bg-sky-300 py-[10px] px-[20px] flex items-center justify-center rounded-[10px] text-base"
            >
              vi
            </Link>
          )}
