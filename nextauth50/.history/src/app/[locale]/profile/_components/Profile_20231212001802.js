  ...
  return (
    <div className="max-w-[1250px] px-[25px] mt-[100px] mx-auto">
      ...
      <div className="mt-[20px] mb-[14px]">
        <h2 className="text-3xl font-bold">Viewed articles</h2>
        <p className="text-center text-xl">{`:( You haven't seen any articles yet`}</p>
      </div>
      <hr />
      <div className="mt-[20px] mb-[14px]">
        <h2 className="text-3xl font-bold">Comment wrote</h2>
        <p className="text-center text-xl">{`:( You haven't seen any post yet`}</p>
      </div>
    </div>
  );
}
